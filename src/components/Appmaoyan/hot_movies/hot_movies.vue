<template>
    <div class='out'>
        ...
        <div>
            ...
            <el-button type="primary" @click='hot_qk'>清空</el-button>
            <el-button type="primary" @click="hotmovies_addmv">新增电影</el-button>
            <!-- dialogFormVisible = true -->

            <!-- 新增rey电影 -->
            <el-dialog title="新增热映电影" :visible.sync="dialogFormVisible" class='addxx' style="width: 100%">

                <el-table ref="multipleTable" :data="movies" tooltip-effect="dark" class='movies_from' @selection-change="handleSelectionChange">
                ...
                <div slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click="hotclickadd">确 定</el-button>
                </div>
        ...
        <el-table ref="multipleTable" :data="hotmovies" tooltip-effect="dark">
            ...
            <el-table-column label="操作" className='manager_cz'>
                <template slot-scope="scope">
                    <el-button size="mini" type="danger" @click="deletRow(scope.$index, hotmovies)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
...
<script>
    export default {
        ...
        computed: {
            // 热映电影
            hotmovies() {
                return this.$store.state.hot_movies.hotmovies1
            },
            // 全部电影
            movies() {
                return this.$store.state.hot_movies.movies
            },
            // 单前页
            curpage() {
                return this.$store.state.hot_movies.curpage
            },
            // 最大页
            maxpage() {
                return this.$store.state.hot_movies.maxpage
            }
        }
    }
</script>
